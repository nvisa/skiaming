...
BEGIN_DISPATCH_MAP(CAutoClickDoc, CDocument)
	...
	DISP_PROPERTY_EX(CAutoClickDoc, "text", GetText, SetText, VT_BSTR)
...
BSTR CAutoClickDoc::GetText()
{
	return m_str.AllocSysString();
}

void CAutoClickDoc::SetText(LPCTSTR lpszNewValue)
{
	m_str = lpszNewValue;
	Refresh();
}
...
{
        // Suppress the PreFast warning here.  This class is returned as an
        // IDispatch pointer and it is up to the caller to ensure it is
        // released.
