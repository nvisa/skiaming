...
/////////////////////////////////////////////////////////////////////////
// FUNCTION: WinMain:³ÌÐòÈë¿Úµã
//
// ARGS:    hInstance       handle to current instance:µ±Ç°ÊµÀý¾ä±ú
//          hPrevInstance   handle to previous instance, if any:ÉÏÒ»ÊµÀý¾ä±ú
            ...
            LPSTR  lpszCmdLine, int CmdShow)
{
	...
	if (!InitTWMain(hInstance))		//Éè¼Æ´°¿ÚÀà,²¢×¢²á
	{
		return (FALSE);
	}
...
BOOL InitTWMain(HANDLE hInstance)
{
	...
	// Set up application's main window:Éè¼Æ´°¿ÚÀà
...
/////////////////////////////////////////////////////////////////////////////////////
// FUNCTION: TW_MainWndProc:´°¿Ú¹ý³Ìº¯Êý
//
...
//-----------------------------------------------------------------
		/*
		* Generate the vertical scroll bar codes:´¹Ö±¹ö¶¯Ìõ
		*/
		case WM_VSCROLL:
			bSelection = TRUE;
...
//-----------------------------------------------------------------
		/*
		* Generate the Horizontal scroll bar codes:Ë®Æ½¹ö¶¯Ìõ
		*/
		case WM_HSCROLL:
			bSelection = FALSE;
...
//-----------------------------------------------------------------
		/*
		* Generate the key down codes:°´¼üÏûÏ¢
		*/
		case WM_KEYDOWN:
...
//-----------------------------------------------------------------
				...
				{   
					...
					if (!TWIsDSOpen())		//ÅÐ¶ÏDSÊÇ·ñ´ò¿ª,Ã»ÓÐ´ò¿ªÊ±,½øÐÐÉèÖÃ×´Ì¬
					{
						dsID.Id = 0;		//dsID±êÃ÷DS×´Ì¬
