...
SKINPPWTL_API HGDIOBJ skinppGetResFromID(PRESINFO pResInfo);
	...
	#ifdef _DEBUG
		#pragma comment(lib, "SkinPPD6.lib")
	#else
		#pragma comment(lib, "SkinPPR6.lib")
	#endif

#else

// 	#ifdef _DEBUG
// 		#pragma comment(lib, "SkinPP/SkinPPD8.lib")
// 	#else
// 		#pragma comment(lib, "SkinPP/SkinPPR8.lib")
// 	#endif
